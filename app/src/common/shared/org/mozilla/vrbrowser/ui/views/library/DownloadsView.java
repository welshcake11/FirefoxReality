...
public class DownloadsView extends LibraryView implements DownloadsManager.DownloadsListener {
    ...
    private DownloadsCallback mDownloadsCallback = new DownloadsCallback() {
        @Override
        public void onClearDownloads(@NonNull View view) {
        ...
        public void onDeleteDownloads(@NonNull View view) {
            view.requestFocusFromTouch();
            mDownloadsManager.removeAllDownloads();
            // TODO Show a confirmation dialog
            hideContextMenu();
        }
    ...
    private DownloadsContextMenuCallback mCallback = new DownloadsContextMenuCallback() {
        ...
        @Override
        public void onClear(DownloadsContextMenuWidget.DownloadsContextMenuItem item) {
            mDownloadsManager.clearDownload(item.getDownloadsId());
            hideContextMenu();
        }
    ...
    @Override
    public void onDownloadError(@NonNull String error) {
        Log.e(LOGTAG, error);
    }
}
