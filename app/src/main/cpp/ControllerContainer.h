...
public:
  ...
  void SetControllerType(const int32_t aControllerIndex, mozilla::gfx::VRControllerType aType) override;
  void SetTargetRayMode(const int32_t aControllerIndex, mozilla::gfx::TargetRayMode aMode) override;
